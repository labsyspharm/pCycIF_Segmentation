...
drugs = dir('/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/tfRatios/spreadsheets/proteome/highdose/*');
for i = 3:length(drugs) %Cut out ., .., dmso at end
    drugName = drugs(i).name;
    filesDrug = dir(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/tfRatios/spreadsheets/proteome/highdose/' drugName '/*']);
    ...
    drugdir = ['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/tfRatios/spreadsheets/proteome/highdose/' drugName '/']; 
...
%                 drug = [drug(:,10:24) drug(:,30:end)]; %Cut indices and DNA columns - needs to be different for proteome and signaling
    ...
    %         for j = 1:size(dmso,2)  %observable 
                ...
                tit = [colname{1} ' ' c(filesdmso_absplit{ab}(i).name(56))]; %only works for high dose - filename length dependent 
