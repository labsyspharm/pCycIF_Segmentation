...
for i = 3:length(drugs)-1 %Cut out ., .., dmso at end
...
%         fn1 = '/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/tfRatios/allDrugViolinPlots/';
%         fn2 = [ab_sets{ab} '/'];
%         fn3 = colname{1}
%         fn4 = '_violin.png';
%         fn = [fn1 fn2 fn3 fn4];
