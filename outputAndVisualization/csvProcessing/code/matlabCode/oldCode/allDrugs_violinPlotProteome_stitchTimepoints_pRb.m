...
for thing = 1:length(conditions)
    drugs = dir('/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/nuc_pRbSplit/spreadsheets/highdose/*');
    for i = 11:length(drugs) %Cut out ., .., dmso at end
        drugName = drugs(i).name;
        filesDrug = dir(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/nuc_pRbSplit/spreadsheets/highdose/' drugName '/' conditions{thing} '/*']);
        filesDrug = filesDrug(3:end);


        %Keep DMSO separate, need at every iteration. 
        filesdmso = dir(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/nuc_pRbSplit/spreadsheets/highdose/DMSO/' conditions{thing} '/*']);
        ...
        dmsodir = ['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/nuc_pRbSplit/spreadsheets/highdose/DMSO/' conditions{thing} '/'];
        drugdir = ['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/nuc_pRbSplit/spreadsheets/highdose/' drugName '/' conditions{thing} '/']; 
