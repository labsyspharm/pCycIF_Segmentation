...
% conditions = {'mlc2v_high','mlc2v_low'};
conditions = {'mlc2v_low'};

for thing = 1:length(conditions)
    drugs = dir('/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/spreadsheets/highdose/*');
    for i = 11:length(drugs) %Cut out ., .., dmso at end
        drugName = drugs(i).name;
        filesDrug = dir(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/spreadsheets/highdose/' drugName '/' conditions{thing} '/*']);
        filesDrug = filesDrug(3:end);


        %Keep DMSO separate, need at every iteration. 
        filesdmso = dir(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/spreadsheets/highdose/DMSO/' conditions{thing} '/*']);
        ...
        % filesdmso = dir('/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/spreadsheets/signaling/highdose/dmso/*');
        % filesdmso = filesdmso(3:end);
        % filessoraf = dir('/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/spreadsheets/signaling/highdose/soraf/*');
        % filessoraf = filessoraf(3:end);

        dmsodir = ['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/spreadsheets/highdose/DMSO/' conditions{thing} '/'];
        drugdir = ['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/spreadsheets/highdose/' drugName '/' conditions{thing} '/']; 
        ...
        %                 drug = [drug(:,10:24) drug(:,30:end)]; %Cut indices and DNA columns - needs to be different for proteome and signaling
            ...
            %             legend('DMSO','Sorafenib','Location','northwest')
                    ...
                    if ~exist(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/violinPlots/' drugName],'dir')
                        mkdir(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/violinPlots/' drugName])
                    end
                    if ~exist(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/violinPlots/' drugName '/' conditions{thing} '/'],'dir')
                        mkdir(['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/violinPlots/' drugName '/' conditions{thing} '/'])
                    end

                    %Save figure 
                    fn1 = ['/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/newSegmentationData/dapiAdded/csvProcessing/mlc2vSplit/violinPlots/' drugName '/' conditions{thing} '/'];
                    fn2 = colname{1}
                    fn3 = ['_' ab_sets{ab}]
                    fn4 = '_violin.png';
                    fn = [fn1 fn2 fn3 fn4];
        ...
        %         ab
        %         fn1
        %         system(['dropbox exclude add' fn1])
            end
