...
#manually added ouput/normalization > filteredNC for final set of files. 
#/home/bobby/Dropbox/MATLAB/cardiotoxCycif/segmentation/pCycIF_Segmentation/output/normalized/filteredNC
